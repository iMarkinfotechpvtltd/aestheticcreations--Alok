<?php
/**
* WP Post Template: Neuromodulatorsnew page  
*/
get_header(); 
global $post;
?>
            ...
            <div class="services-section-wrapper">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12 pull-right">
                        <div class="services-right-side">
                            <div class="services-right-side-text">
                                <?php the_field('neuromodulators_wrinkle_relaxers',$post->ID) ?>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="services-left-side">
                            <div class="services-left-side-text">
                                <?php the_field('who_should_not_use_these',$post->ID) ?>
                                 <?php the_field('if_you_have_had_a_prior',$post->ID) ?>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <div class="services-right-side">
						<?php
							$image=get_post_meta($post->ID,"right_side_image",true);
							$thumb = wp_get_attachment_image_src($image, 'service1' );?>
							<?php if($thumb==""){?>
							<img src="http://placehold.it/661x576&amp;text=No image found" alt="testmonials-img"/>
							<?php
							}else{?>
							<img src="<?php echo $url = $thumb['0'];?>" alt="<?php the_title(); ?>" class="img-responsive"><?php } ?>
